...
The current contract version is `0.1.0-alpha.4`. Python publishes the equivalent
PEP 440 version `0.1.0a4`; npm and the Git tag use `0.1.0-alpha.4` and
`v0.1.0-alpha.4`. Pre-1.0 changes may be incompatible and must be called out
explicitly.
