...
same RFC 8785 digest profile as Python. It does not yet include the Python SDK's
metric emitter, usage rollup helper, source adapters, or TRACE finalizer. Those
